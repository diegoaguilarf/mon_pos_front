<template>
  <div class="relative inset-y-0 right-0 flex w-full h-full">
      ...
      <div class="border-t border-gray-200">
        <div class="grid grid-cols-3">
          ...
          <div class="flex-1 py-4 text-center border-r border-b border-gray-200 cursor-pointer"
            :class="mainStore?.orderAddresses ? 'bg-green-600 text-white' : ''" @click="toggleAddresses">
            <p>{{ mainStore?.orderAddresses?.neighborhood?.name || "Dirección" }}</p>
          </div>
          <div class="flex-1 py-4 text-center border-r border-b border-gray-200 cursor-pointer"
    ...
    <BottomSheet title="Escoge una dirección" :show="addressesBottomSheet" @close="toggleAddresses">
      <AddressesList :values="mainStore.orderAddresses"/>
    </BottomSheet>
  </div>
</template>
...
const subtotalOrder = computed(() => mainStore.subtotalOrder);
const addressesBottomSheet = computed(() => mainStore.addressesBottomSheet);
